...
document.onclick = () => {
    if(event.target != document.querySelector(".list_item") && event.target != document.querySelector(".navbar .menu")&& event.target != document.querySelector(".navbar .menu i")){
        document.querySelector(".list_item").classList.remove('show')
    }
